import { pgTable, foreignKey, pgEnum, uuid, text, timestamp, jsonb, boolean, bigint, integer } from "drizzle-orm/pg-core"
...
export const workspaces = pgTable("workspaces", {
	...
	workspace_owner: uuid("workspace_owner").notNull().references(() => profiles.id, { onDelete: "cascade" } ),
	created_at: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow(),
});

export const files = pgTable("files", {
	id: uuid("id").defaultRandom().primaryKey().notNull(),
	folder_id: uuid("folder_id").notNull().references(() => folders.folder_id, { onDelete: "cascade" } ),
	title: text("title").notNull(),
	icon_id: text("icon_id").notNull(),
	data: text("data"),
	in_trash: text("in_trash"),
...
export const folders = pgTable("folders", {
	folder_id: uuid("folder_id").defaultRandom().primaryKey().notNull(),
	title: text("title").notNull(),
	icon_id: text("icon_id").notNull(),
	data: text("data"),
	in_trash: text("in_trash"),
