    ...
    <header className="p-4 flex justify-between items-center">
      <Link href="/" className="w-full flex justify-left items-center">
        <Image
          ...
          height={25}
        />
        <span className="font-semibold dark:text-white">propilot.</span>
      </Link>
          ...
          <NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <ul className="grid w-[400px] gap-3 p-4  md:grid-row-2  ">
                ...
                <ListItem key={"Pro Plan"} title={"Free Plan"} href={"#"}>
    ...
    <li>
      <NavigationMenuLink asChild>
        <a
          ref={ref}
          className={cn(
            " group block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:dark:bg-accent/30 text-card-foreground/60 focus:bg-accent focus:text-accent-foreground",
            className
          )}
          {...props}
        >
          ...
          <p className="text-gray-600 group-hover:dark:text-white/70  line-clamp-2 text-sm leading-snug text-white/40">
            {children}
          </p>
        </a>
      </NavigationMenuLink>
